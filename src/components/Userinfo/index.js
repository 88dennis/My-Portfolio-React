...
function Userinfo({ showMeUserInfo, useEmail, useId, hideShowUserInfo, usefirstName, uselastName, userestaurantName, handleLogout }) {
  return (

    <div>
    {showMeUserInfo ?
      <div className="overlay8" onClick={() => hideShowUserInfo(useId)}>
