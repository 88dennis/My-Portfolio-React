...
function ModalDms({ showMe2, hideShow2, name, lastName, email,password, handleAddEmployeeChange, handleAddEmpolyeeFormSubmit }) {
  return (

    <div>
    {showMe2 ?
      <div className="overlayBack" onClick={() => hideShow2()}>
       Dennis
      </div>
      :null
    }
